...
$queryResult = $mysqli->query('CREATE TABLE IF NOT EXISTS category (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, created_by INT NOT NULL, name VARCHAR(100) NOT NULL, description TEXT NOT NULL, image VARCHAR(100) NOT NULL, active TINYINT(1) DEFAULT 1, CONSTRAINT fk_category_user_id FOREIGN KEY (created_by) REFERENCES user(id))');
